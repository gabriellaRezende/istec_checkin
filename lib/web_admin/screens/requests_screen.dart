          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final studentName =
                    (request['student_name'] ?? 'Aluno').toString();
                final studentEmail =
                    (request['student_email'] ?? '-').toString();
                final eventName =
                    (request['event_name'] ?? 'Evento').toString();
                final eventAddress =
                    (request['event_address'] ?? '').toString();
                final distance =
                    (request['distance_meters'] ?? 0).toString();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _RequestInfoRow(
                          label: 'Distância',
                          value: '${double.tryParse(distance)?.toStringAsFixed(1) ?? distance} m',
                        ),
